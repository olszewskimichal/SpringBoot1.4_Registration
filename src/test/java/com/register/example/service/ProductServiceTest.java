...
public class ProductServiceTest extends IntegrationTestBase {
    ...
    public void shouldReturn2ProductsDTODesc(){
        ...
        Integer page=null;
        String sort="desc";
        List<ProductDTO> expectedProduct= Arrays.asList(new ProductDTOBuilder("produkt3").build(),new ProductDTOBuilder("produkt2").build());
        ...
        assertThat(productDTOList.get(0).getPrice().stripTrailingZeros()).isEqualTo(expectedProduct.get(0).getPrice().stripTrailingZeros());
        ...
        assertThat(productDTOList.get(1).getPrice().stripTrailingZeros()).isEqualTo(expectedProduct.get(1).getPrice().stripTrailingZeros());
    ...
    public void shouldReturn3ProductsDTOWithDefaultSettings(){
        //given
        List<ProductDTO> expectedProduct= Arrays.asList(new ProductDTOBuilder("produkt1").build(),new ProductDTOBuilder("produkt2").build(),new ProductDTOBuilder("produkt3").build());
    ...
    public void shouldReturn2ProductsDesc(){
        ...
        Integer page=null;
        String sort="desc";
        List<Product> expectedProduct= Arrays.asList(new ProductBuilder("produkt3").build(),new ProductBuilder("produkt2").build());
        ...
        assertThat(products.get(0).getPrice().stripTrailingZeros()).isEqualTo(expectedProduct.get(0).getPrice().stripTrailingZeros());
        ...
        assertThat(products.get(1).getPrice().stripTrailingZeros()).isEqualTo(expectedProduct.get(1).getPrice().stripTrailingZeros());
    ...
    public void shouldReturn3ProductsWithDefaultSettings(){
        //given
        List<Product> expectedProduct= Arrays.asList(new ProductBuilder("produkt1").build(),new ProductBuilder("produkt2").build(),new ProductBuilder("produkt2").build());
        ...
        assertThat(productList.get(0).getPrice().stripTrailingZeros()).isEqualTo(expectedProduct.get(0).getPrice().stripTrailingZeros());
    ...
    public void shouldUpdateProduct(){
        //given
        Product createdProduct=productRepository.save(productService.createProduct(new ProductDTOBuilder("test").build()));
    ...
    public void shouldAddProductWithAddProductsRequestWS() throws JsonProcessingException {
        ...
        addProductsRequestWS.setProducts(Arrays.asList(new ProductDTOBuilder("produkt1").build(),new ProductDTOBuilder("produkt2").build(),new ProductDTOBuilder("produkt3").build()));
